  ...
  return (
    <div className="absolute inset-0 bg-neutral-800 z-50 flex flex-col">
      ...
      <div className="flex items-center justify-between px-4 pt-3 pb-2 shrink-0">
        <button
          onClick={onClose}
          className="w-10 h-10 rounded-full bg-neutral-700 flex items-center justify-center active:scale-95"
        >
          <X className="w-5 h-5 text-white" />
        </button>
        <button className="flex items-center gap-2 px-5 py-2.5 bg-white rounded-full font-semibold text-gray-900 active:scale-95">
          Send To
