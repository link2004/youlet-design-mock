...
export const CARD_BACK_EVENTS: Array<{
  ...
  { id: 'approved-1', title: 'Got a new camera', emoji: '📷', date: '3 days ago', description: 'Finally got the Fujifilm X-T5! The colors are incredible, can\'t wait to take it out for some street photography.' },
  { id: 'approved-2', title: 'Into cafe hopping lately', emoji: '☕', date: '1 week ago', description: 'Found this amazing hidden cafe in Shimokitazawa. The pour-over was perfect!' },
];
...
// 友達ごとのAI会話履歴
// 設計意図: 自分のトピック（My Topics）と相手のイベントをAI同士が交換する
// 会話パターン: 自分AI紹介 → 相手AI紹介 → リアクション → バランスよく混ぜる
export const FRIEND_AI_CONVERSATIONS: Record<number, AIConversationMessage[]> = {
  1: [ // Momo
    { id: 'ai-1', sender: 'my_ai', message: "Rikuが新しいカメラを手に入れたんだ！Fujifilm X-T5、色味がすごく綺麗で気に入ってるみたい", timestamp: '3 days ago' },
    { id: 'ai-2', sender: 'their_ai', message: "いいね！Momoもフィルムカメラにハマってて、ヴィンテージのContax買ったんだって", timestamp: '3 days ago' },
    { id: 'ai-3', sender: 'my_ai', message: "フィルムカメラ！エモい写真撮れそう〜。Rikuも興味あるって言ってた", timestamp: '2 days ago' },
    { id: 'ai-4', sender: 'their_ai', message: "うん！Momoは最近、下北沢でジャズカフェ見つけたらしいよ。そこでスケッチしてるんだって", timestamp: '2 days ago' },
    { id: 'ai-5', sender: 'my_ai', message: "あ、Rikuも最近カフェ巡りにハマってる！下北沢の隠れ家カフェ見つけたって", timestamp: '1 day ago' },
    { id: 'ai-6', sender: 'their_ai', message: "え、近いじゃん！Momoも一緒に行きたいって言ってるよ〜", timestamp: '1 day ago' },
  ],
  2: [ // Kento
    { id: 'ai-1', sender: 'my_ai', message: "Rikuが新しいカメラ買ったんだ！ゲームの世界観とか撮りたいって言ってた", timestamp: '5 days ago' },
    { id: 'ai-2', sender: 'their_ai', message: "おお！Kentoはついにラスボス倒したよ！50回以上挑戦したらしい笑", timestamp: '5 days ago' },
    { id: 'ai-3', sender: 'my_ai', message: "すごい！根性あるね〜。Rikuもシミュレーション系やRPGが好きみたい", timestamp: '4 days ago' },
    { id: 'ai-4', sender: 'their_ai', message: "いいね！Kentoは今新しいアニメにもハマってて、作画がヤバいって興奮してたよ", timestamp: '4 days ago' },
  ],
  3: [ // Nina
    { id: 'ai-1', sender: 'my_ai', message: "Rikuがカフェ巡りにハマってるんだけど、Ninaも好きかな？", timestamp: '1 week ago' },
    { id: 'ai-2', sender: 'their_ai', message: "Ninaは毎朝川沿いでヨガしてるよ！今日の朝日は最高だったって", timestamp: '1 week ago' },
    { id: 'ai-3', sender: 'my_ai', message: "朝ヨガ素敵！Rikuも読書が好きで、最近本探してるみたい", timestamp: '6 days ago' },
    { id: 'ai-4', sender: 'their_ai', message: "Ninaは『The Midnight Library』読み始めたって！もうハマってるらしいよ", timestamp: '6 days ago' },
  ],
  4: [ // Ryo
    { id: 'ai-1', sender: 'my_ai', message: "Rikuが下北沢の隠れ家カフェ見つけたんだ！イタリアンもあるみたい", timestamp: '4 days ago' },
    { id: 'ai-2', sender: 'their_ai', message: "イタリアン！Ryoは昨日カルボナーラ手作りしたよ。卵のテンパリングがコツなんだって", timestamp: '4 days ago' },
    { id: 'ai-3', sender: 'my_ai', message: "手作りカルボナーラ！美味しそう〜。Rikuも新しいレストラン開拓するの好きみたい", timestamp: '3 days ago' },
    { id: 'ai-4', sender: 'their_ai', message: "Ryoは中目黒に穴場のイタリアン知ってるらしいよ！Cinemga Paradisoで泣いたって言ってた笑", timestamp: '3 days ago' },
  ],
  5: [ // Sora
    { id: 'ai-1', sender: 'my_ai', message: "Rikuが新しいカメラで風景撮りたいって！どこかいい場所ないかな", timestamp: '1 week ago' },
    { id: 'ai-2', sender: 'their_ai', message: "Soraまた高尾山登ったよ！今回はチャレンジングなルートで、頂上からの景色が最高だったって", timestamp: '1 week ago' },
    { id: 'ai-3', sender: 'my_ai', message: "高尾山いいね！Rikuも行ってみたいって言ってた。いつがベストシーズン？", timestamp: '5 days ago' },
    { id: 'ai-4', sender: 'their_ai', message: "Soraは秋の早朝がおすすめだって！日の出の景色がすごいらしいよ", timestamp: '5 days ago' },
  ],
  6: [ // Leon
    { id: 'ai-1', sender: 'my_ai', message: "Rikuもゲーム好きなんだ！最近はシミュレーション系やってるみたい", timestamp: '3 days ago' },
    { id: 'ai-2', sender: 'their_ai', message: "Leonは新作ゲームの発売日にコレクターズエディションゲットしたよ！もう10時間プレイしてる笑", timestamp: '3 days ago' },
    { id: 'ai-3', sender: 'my_ai', message: "すごい！Rikuもインディーゲーム好きみたい。おすすめある？", timestamp: '2 days ago' },
    { id: 'ai-4', sender: 'their_ai', message: "LeonのイチオシはHadesだって！50周くらいやってるらしいよ笑", timestamp: '2 days ago' },
  ],
  7: [ // Akane
    { id: 'ai-1', sender: 'my_ai', message: "Rikuが新しいカメラでアート撮影にも挑戦したいって言ってた", timestamp: '5 days ago' },
    { id: 'ai-2', sender: 'their_ai', message: "Akaneは六本木のデジタルアート展に行ったよ！すごくインスパイアされたって", timestamp: '5 days ago' },
    { id: 'ai-3', sender: 'my_ai', message: "デジタルアート展！Rikuも新しいアーティスト発見するの好きみたい", timestamp: '4 days ago' },
    { id: 'ai-4', sender: 'their_ai', message: "あと、Akaneはギター習い始めたらしい！指は痛いけど基本コード弾けるようになったって", timestamp: '4 days ago' },
  ],
  8: [ // Kai
    { id: 'ai-1', sender: 'my_ai', message: "Rikuが新しいカメラで旅行写真撮りたいって！どこか行きたい場所あるのかな", timestamp: '6 days ago' },
    { id: 'ai-2', sender: 'their_ai', message: "Kaiは京都旅行計画中だよ！お寺とか穴場スポット調べてるみたい。紅葉が楽しみだって", timestamp: '6 days ago' },
    { id: 'ai-3', sender: 'my_ai', message: "京都いいね！Rikuも行きたいって言ってたよ", timestamp: '5 days ago' },
    { id: 'ai-4', sender: 'their_ai', message: "一緒に行く？Kaiは秘密のハイキングコース見つけたらしいよ。滝があるところ！", timestamp: '5 days ago' },
  ],
  9: [ // Miku
    { id: 'ai-1', sender: 'my_ai', message: "Rikuが隠れ家カフェでまったりするの好きなんだ。Mikuもカフェ好き？", timestamp: '2 days ago' },
    { id: 'ai-2', sender: 'their_ai', message: "Mikuは昨日おうちでジブリ映画3本連続で観たって！雨の日にぴったりだったらしい", timestamp: '2 days ago' },
    { id: 'ai-3', sender: 'my_ai', message: "ジブリ最高だよね！Rikuもインディー映画が好きみたい", timestamp: '1 day ago' },
    { id: 'ai-4', sender: 'their_ai', message: "Mikuもインディー映画好きだって！あとコーヒーとヨガもハマってるよ", timestamp: '1 day ago' },
  ],
  10: [ // Yuto
    { id: 'ai-1', sender: 'my_ai', message: "Rikuがカフェ巡りにハマってて、美味しいラーメン屋も探してるみたい", timestamp: '4 days ago' },
    { id: 'ai-2', sender: 'their_ai', message: "ラーメン！Yutoは新しいレシピで豚骨ブロスを12時間煮込んだよ！", timestamp: '4 days ago' },
    { id: 'ai-3', sender: 'my_ai', message: "12時間！すごい本格的だね。家で作るコツある？", timestamp: '3 days ago' },
    { id: 'ai-4', sender: 'their_ai', message: "時間かけてじっくり煮込むのがポイントだって！あとYutoは沖縄行きのフライトも予約したよ。初めての沖縄だって！", timestamp: '3 days ago' },
  ],
};
